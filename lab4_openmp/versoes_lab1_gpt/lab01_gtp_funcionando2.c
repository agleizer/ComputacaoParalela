 ...
 * Cada thread trabalha em um subintervalo exclusivo para evitar cálculos duplicados.
 *
 * Parâmetros:
...
/*
 * Agora utilizamos a diretiva "parallel" para dividir o trabalho entre as threads.
 * Cada thread calcula um subintervalo exclusivo, evitando cálculos duplicados.
 * Usamos "reduction(+: global_result)" para acumular corretamente os resultados.
 */
